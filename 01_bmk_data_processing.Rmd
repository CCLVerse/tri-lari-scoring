...
## this ordering is important to generate consistent lavaan results. Based on the ordering of the raters, the results will be different.
raters <- c("Self","Direct Report","Boss","Peer")
