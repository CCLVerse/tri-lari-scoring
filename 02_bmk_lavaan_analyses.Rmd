...
compute_factor_score_correlation(df=avg_scores_by_rater_df_merged
...
avg_scores_by_rater_df_merged %>% select(c(names(factor_score_equations), BMK_S5_1_mean_all_rater)) %>% cor() 

compute_factor_score_correlation(df=avg_scores_by_rater_df_merged
                               , x = names(factor_score_equations)
                               , y = avg_scores_by_rater_df_merged$BMK_S5_1_mean_all_rater)
