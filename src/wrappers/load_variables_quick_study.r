#' Load variables for analysis for Being a Quick Study
#'
...
#'
#' @export
load_variables_quick <- function(data=data.frame(), 
  ...
  list(
    ...
    column_pattern_for_analyses = "ESI_Key|BMK_S1_11|BMK_S1_30|BMK_S1_45|BMK_S2_8|BMK_S2_13|BMK_S2_15|BMK_S2_19|BMK_S2_22|BMK_S2_17|BMK_S2_25|BMK_S2_35|BMK_S2_18|BMK_S2_21|BMK_S2_23|BMK_S2_28|BMK_S2_30|BMK_S2_34|BMK_S2_36|BMK_S2_6|BMK_S2_7|BMK_S2_12|BMK_S2_14|BMK_S2_10|BMK_S2_5|BMK_S2_16|BMK_S2_26|BMK_S2_24|BMK_S2_33|BMK_S2_2|BMK_S2_20|BMK_S2_27|BMK_S2_29|BMK_S2_31|BMK_S2_32|BMK_S2_3|BMK_S2_4|BMK_S2_1|BMK_S2_11|BMK_S2_9|BMK_S5_1|BMK_S5_2|BMK_S5_3|BMK_S5_4|BMK_S5_5|BMK_S5_6|BMK_S5_7|BMK_S5_8|BMK_S5_9",
    rowmeans_columns_list = list(
      c("BMK_S1_11_mean_Self", "BMK_S1_30_mean_Self", "BMK_S1_45_mean_Self"),
      c(
        "BMK_S1_11_mean_Direct_Report",
        "BMK_S1_30_mean_Direct_Report",
        "BMK_S1_45_mean_Direct_Report"
      ),
      c("BMK_S1_11_mean_Boss", "BMK_S1_30_mean_Boss", "BMK_S1_45_mean_Boss"),
      c("BMK_S1_11_mean_Peer", "BMK_S1_30_mean_Peer", "BMK_S1_45_mean_Peer"),
      c(
        "BMK_S1_11_mean_Direct_Report",
        "BMK_S1_30_mean_Direct_Report",
        "BMK_S1_45_mean_Direct_Report",
    ...
    regex_pattern = TRUE,
    competency_cols_pattern = "BMK_S1_11|BMK_S1_30|BMK_S1_45",
    competency_cols_with_factor_weights = "BMK_S1_(11|30|45)(?!.*quick).*",
    columns_to_remove_missing_values = "ESI_Key|BMK_S1_11|BMK_S1_30|BMK_S1_45",
    factor_weights_competency_cols = "\\w+_S1_(11|30|45)(?!.*quick).*",
    factor_weights_cols = "\\w+_S1_(11|30|45)(.*quick).",
