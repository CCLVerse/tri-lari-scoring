...
correlation %>% 
  ...
  kable_styling(bootstrap_options = c("striped", "hover")) %>%
  column_spec(1, bold=TRUE) %>% 
  footnote(sprintf("Correlations above the diagonal in each matrix are from the Normative sample, those below the diagonal are from the cross-validation sample.$N_{normative}$ = %s. Correlations ≥ |.03| are significant at p < .05. ", n_normative))
